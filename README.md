...
Design: `docs/ideas-dailies-slate-mvp.md` at the repo root. Implemented so far: stage 1 of the funnel (mechanical, CPU only) and the morning report. VLM screening comes next.
